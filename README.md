...
* Dependency injection pattern can be used to inject part of the system tested, here the repository implmentation specified by the interface `IItemRepository`. It is the case for all the test implementation of the example that they get injected the repository to test like this.
