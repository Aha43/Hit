...
namespace HitUnitTests
{
    public class UnitTests1_space
    {
        ...
        [Fact]
        public void NumberOfUnitTestsShouldBeFour() => Assert.Equal(4, _unitTestsSpace.GetUnitTests().UnitTestCount);
        [Fact]
        public void NumberOfUnitTestCoordinatesShouldBeFour() => Assert.Equal(4, _unitTestsSpace.UnitTestCoordinates.Count());
        [Theory]
